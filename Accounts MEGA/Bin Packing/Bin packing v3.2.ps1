Function WriteLog($LogLine){
    $LogLine | Out-File -FilePath ($FolderBrowser.SelectedPath+'\Packs.log') -Append
}
...
"[SIZE]: " + [string]$Storage+$Unit) | Out-File -FilePath ($FolderBrowser.SelectedPath+'\Packs.log') #CREAZIONE/RESET LOG
